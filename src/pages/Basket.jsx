  ...
  return (
...

    {
      ...
      <div className="w-full mt-8 cotn flex justify-between gap-5">
        ...
        <div className="w-[30%] arr h-fit counter py-[43px] px-[30px]">
      ...
      <h1 className=" text-[32px] font-semibold">В корзине пока нет товаров</h1>
      <p className=" text-sm font-medium">Начните с подборок на главной странице или найдите нужный товар через поиск</p>
    </div>
    }
    </div>
  );
